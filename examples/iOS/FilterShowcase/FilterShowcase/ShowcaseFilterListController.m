...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	switch (index)
	{
        case GPUImage_OLDPHOTO: cell.textLabel.text = @"old"; break;
        case GPUIMAGE_PIXELATION: cell.textLabel.text = @"pixelation"; break;
		case GPUIMAGE_SATURATION: cell.textLabel.text = @"my"; break;
